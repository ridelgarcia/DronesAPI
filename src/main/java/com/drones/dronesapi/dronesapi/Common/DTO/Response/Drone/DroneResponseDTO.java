...
public class DroneResponseDTO {
	...
	public DroneResponseDTO(long id, String serialNumber, DroneModelDTO model, int weightLimit, int batteryCapacity,
			DroneStateDTO state) {
	...
	public String toString() {
		return "DroneResponseDTO [id=" + id + ", serialNumber=" + serialNumber + ", model=" + model + ", weightLimit="
